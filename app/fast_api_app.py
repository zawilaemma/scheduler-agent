...
from app.logging_config import JsonLoggingPlugin, setup_logging
...
app.title = "scheduler-agent"
app.description = "API for interacting with the Agent scheduler-agent"
